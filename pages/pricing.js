    ...
    return (
        ...
        >
            ...
            <div className="grid md:grid-cols-3 gap-8 not-prose my-12">
                ...
                {/* Free Tier */}
                <div className="bg-[#080809] border border-white/10 rounded-none p-8 flex flex-col">
                    ...
                    <a href="#" className="block text-center py-3 rounded-none bg-[#111827] text-white border border-white/20 hover:border-[#10B981]/50 hover:text-[#10B981] font-mono text-xs uppercase tracking-widest transition-colors">Get Started</a>
                </div>

                {/* Pro Tier */}
                <div className="bg-[#10B981]/10 border border-[#10B981] rounded-none p-8 flex flex-col relative overflow-hidden">
                    <div className="absolute top-0 right-0 bg-[#10B981] text-[#080809] font-mono text-[10px] tracking-widest uppercase px-3 py-1 rounded-none">Popular</div>
                    ...
                    <a href="#" className="block text-center py-3 rounded-none bg-[#10B981] text-[#080809] font-mono text-xs uppercase tracking-widest hover:bg-[#059669] transition-colors border border-[#10B981]">Start Free Trial</a>
                </div>
                ...
                <div className="bg-[#080809] border border-white/10 rounded-none p-8 flex flex-col">
                    ...
                    <a href="#" className="block text-center py-3 rounded-none bg-[#111827] text-white border border-white/20 hover:border-[#10B981]/50 hover:text-[#10B981] font-mono text-xs uppercase tracking-widest transition-colors">Contact Sales</a>
                </div>
