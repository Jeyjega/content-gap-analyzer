...
import { Buffer } from 'node:buffer'; // Explicitly import Buffer for Edge
  ...
  try {
    ...
    const stream = new ReadableStream({
      async start(controller) {
        ...
        try {
          // Log start (In Edge logging to console works but shows in Vercel logs)
          ...
          const ytdlOptions = {
            ...
            saveDebugFile: false, // DISABLE DEBUG WRITES (Fixes EROFS)
          };
    ...
    return new Response(stream, {
      headers: {
        ...
        // 'Transfer-Encoding': 'chunked' is implied by ReadableStream in strict HTTP/2 or handle by platform
